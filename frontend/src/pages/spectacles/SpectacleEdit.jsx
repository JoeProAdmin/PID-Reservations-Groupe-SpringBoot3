...
const SpectacleEdit = () => {
  ...
  useEffect(() => {
    Promise.all([
      ...
      .then(([spectacleData, artistsData]) => {
        setFormData({
          title: spectacleData.title || "",
          description: spectacleData.description || "",
          date: spectacleData.date ? spectacleData.date.substring(0, 16) : "",
          location: spectacleData.location || "",
          price: spectacleData.price || "",
          artistId: spectacleData.artist ? spectacleData.artist.id : "",
        });
  ...
  const handleSubmit = () => {
    if (
      ...
      setError("Titre, date, prix et artiste sont obligatoires.");
      return;
    }
    setSaving(true);
    setError(null);
    ...
    fetch(`${API_URL}/api/spectacles/${id}`, {
      ...
      body: JSON.stringify({
        ...
        artist: { id: parseInt(formData.artistId) },
      }),
    })
      .then((res) => {
        if (!res.ok)
              ...
              <div className="agency-card">
                ...
                <div className="card-content">
                  ...
                  <div className="row g-3 mt-1">
                    <div className="col-md-6">
                      <label className="agency-label">Artiste *</label>
                      <select
                        id="artistId"
                        className="form-control"
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="btn btn-primary btn-xl text-uppercase btn-admin"
                    >
                      {saving ? (
                        <>
